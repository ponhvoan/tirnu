...
augmentations = [
    autocontrast,
    equalize,
    lambda x: rotate(x, severity),
    lambda x: solarize(x, severity),
    lambda x: shear_x(x, severity),
    lambda x: shear_y(x, severity),
    lambda x: translate_x(x, severity),
    lambda x: translate_y(x, severity),
    lambda x: posterize(x, severity),
]
